  ...
  return (
    <div className='flex flex-col sm:flex-row justify-between items-center w-full px-4 py-3 bg-white/5 backdrop-blur-md border-b border-white/10 z-50 transition-all'>
      ...
      <div className='w-full sm:w-auto mb-3 sm:mb-0 flex justify-center sm:justify-start'>
        <button className='w-full sm:w-auto text-white bg-green-600 hover:bg-green-500 border border-green-500/50 hover:border-green-400 p-2 px-6 rounded-xl transition-all shadow-[0_0_15px_rgba(22,163,74,0.3)] hover:shadow-[0_0_20px_rgba(22,163,74,0.5)] font-semibold tracking-wide'>
